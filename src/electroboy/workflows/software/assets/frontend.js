(function () {
  ...
  async function openProjectCorkboard() {
    try {
      await runtimeApi.modules.invoke("corkboard", "openDocument", {
        stage: "corkboard",
      });
    } catch (error) {
  ...
  async function newProjectCorkboard() {
    try {
      await runtimeApi.modules.invoke("corkboard", "newDocument", {
        stage: "corkboard",
      });
    } catch (error) {
      appendOutput(`${error.message || "corkboard creation failed"}\n`, "error");
    }
  }
  ...
  window.ElectroBoyFrontend.registerWorkflow({
    ...
    paneKinds: [
      ...
      "corkboard",
      {
        kind: "agenda",
        disabled: true,
        title: "Agenda is not available for software projects yet.",
      },
      {
        kind: "calendar",
        disabled: true,
        title: "Calendar is not available for software projects yet.",
      },
      "mind-map",
      "progress",
      "scratch",
