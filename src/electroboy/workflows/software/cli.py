"""Command-line interface for the software-engineering workflow."""
    ...
    prompts = {
        STAGE_REQUIREMENTS: [
            ...
            *_structured_prompt_block(
            ...
            f"Edit only {requirements_jsonl} directly unless",
            "the operator explicitly asks for another change.",
            f"Refresh {requirements_path} only with `electroboy render-artifact",
            "requirements`.",
        ...
        STAGE_DESIGN: [
            ...
            *_structured_prompt_block(
            ...
            f"Edit only {design_jsonl} directly unless the operator",
            "explicitly asks for another change.",
            f"Refresh {design_path} only with `electroboy render-artifact",
            "design`.",
            "If the operator asks you to update another artifact, do it and",
            "report which files changed and why.",
        ],
        STAGE_PLAN: [
            ...
            *_structured_prompt_block(
            ...
            f"Edit only {plan_jsonl} directly unless the operator",
            "explicitly asks for another change.",
            f"Refresh {plan_path} only with `electroboy render-artifact",
            "implementation-plan`.",
            "If the operator asks you to update another artifact, do it and",
            "report which files changed and why.",
        ],
        STAGE_TEST_PLAN: [
            ...
            *_structured_prompt_block(
            ...
            f"Edit only {test_plan_jsonl} directly unless the",
            "operator explicitly asks for another change.",
            f"Refresh {test_plan_path} only with `electroboy render-artifact",
            "test-plan`.",
            "If the operator asks you to update another artifact, do it and",
            "report which files changed and why.",
        ],
...
@dataclass(frozen=True)
class SoftwareCommandProvider:
    """CLI contribution loaded when the software workflow is installed."""
...
def command_provider() -> SoftwareCommandProvider:
    """Return the software workflow's command provider."""

    return SoftwareCommandProvider()
