...
range end to be current `HEAD` and the tracked working tree to be clean.
ElectroBoy reruns range review, up to five attempts. Minor findings remain
recorded but do not force a fix commit or rewrite.
